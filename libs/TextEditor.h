...
public:
	...
	void SetFlagPoints(std::vector<int> flagPoints);

	bool FindFlagLine(int lineIndex) const;
	bool FindFlagPoint(int lineIndex) const;
	bool FindFlagPointRect(int lineNo, ImVec4 *rect) const;
